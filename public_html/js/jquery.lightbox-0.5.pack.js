	...
	$.fn.lightBox = function(settings) {
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			...
			if(intImageWidth > ($(window).width()-50)){
				...
				if(intImageHeight > ($(window).height()-130)) {
					intImageWidth = (intImageWidth/intImageHeight)*($(window).height()-130);
					intImageHeight = ($(window).height()-130);
				}
			}else if(intImageHeight > ($(window).height()-130)){
				intImageWidth = (intImageWidth/intImageHeight)*($(window).height()-130);intImageHeight = ($(window).height()-130);
			}
