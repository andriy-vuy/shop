 ...
 * @version 1.0
 */
class Application_Form_Productedit extends Zend_Form
{
    ...
    public function init()
    {
		...
		$this->addElements(array($p_title, $p_code, $p_cat_id, $p_markup, $p_metakeywords, $p_metadescription, $p_text, $p_price, $p_quantity, $p_status, $submit));
    }
